...
class DQERQueueLearning : public Agent
{
  ...
  public:
    DQERQueueLearning(size_t _nrEpisodes = 10000, OpModellingType pOpModellingType = OpModellingType::ONEFORALL, float _alpha = 0.001, float _epsilon = 0.1, float _gamma=0.9);
